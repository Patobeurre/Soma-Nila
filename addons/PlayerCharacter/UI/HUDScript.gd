...
@onready var staminaProgressBar = $StaminaContainer/MarginContainer/ProgressBar

@onready var reticleSquare = $CenterContainer/SquaredReticle
@onready var reticleArrow = $CenterContainer/ArrowReticle
...
func displayStamina(stamina : float):
	staminaProgressBar.visible = stamina < staminaProgressBar.max_value
	staminaProgressBar.value = stamina
	staminaLT.set_text(str(stamina))

func displayReticleSquare(enabled :bool):
	reticleSquare.visible = enabled

func displayReticleArrow(enabled :bool):
	reticleArrow.visible = enabled
